...
# Secured exclusively to your Telegram User ID
ALLOWED_USER_IDS = [
    6124380017
]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        "• `/download <link>` - Download TikTok / Social media video\n"
        ...
        try:
            ...
            if time_str in ["13:29", "14:45"]:
                ...
                if trigger_key not in triggered_today and ALERT_CHAT_ID:
                    ...
                    # Auto scan Gold, EUR/USD, S&P 500, Bitcoin
                    for symbol in ["GC=F", "EURUSD=X", "^GSPC", "BTC-USD"]:
                        try:
